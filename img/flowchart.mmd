flowchart TD
    ...
    TelemetryInit --> MainLoopStart[Pętla Główna - while 1]

    MainLoopStart --> Sec1_ResetCheck{Zrestartować MCU?<br/>HAL_GetTick - lastReboot > reset_time}
    ...
    StartWindowTimer --> W_FeedWDT[HAL_IWDG_Refresh]

    W_FeedWDT --> W_CheckRX{Odbiór na loraRX?}
    W_CheckRX -- Tak --> W_PushRX[Pobierz i dodaj do kolejki]
    W_PushRX --> W_CheckTX{Odbiór odpowiedzi na loraTX?}
    W_CheckRX -- Nie --> W_CheckTX
    ...
    PWR_Sleep --> MainLoopStart
    Sec5_Sleep -- Nie --> MainLoopStart
